...
class DatePeriod
{
    ...
    {
        return [
            ['min' => 0, 'max' => 10, 'только что', 'только что',],
            ['min' => 10, 'max' => 20, '10 секунд назад', '10 сек'],
            ['min' => 20, 'max' => 30, '20 секунд назад', '20 сек'],
            ['min' => 30, 'max' => 40, '30 секунд назад', '30 сек'],
            ['min' => 40, 'max' => 50, '40 секунд назад', '40 сек'],
            ['min' => 50, 'max' => 60, '50 секунд назад', '50 сек'],
            ['min' => 60, 'max' => 60 * 2, '1 минуту назад', '1 мин'],
            ['min' => 60 * 2, 'max' => 60 * 3, '2 минуты назад', '2 мин'],
            ['min' => 60 * 3, 'max' => 60 * 4, '3 минуты назад', '3 мин'],
            ['min' => 60 * 4, 'max' => 60 * 5, '4 минуты назад', '4 мин'],
            ['min' => 60 * 5, 'max' => 60 * 6, '5 минут назад', '5 мин'],
            ['min' => 60 * 6, 'max' => 60 * 7, '6 минут назад', '6 мин'],
            ['min' => 60 * 7, 'max' => 60 * 8, '7 минут назад', '7 мин'],
            ['min' => 60 * 8, 'max' => 60 * 9, '8 минут назад', '8 мин'],
            ['min' => 60 * 9, 'max' => 60 * 10, '9 минут назад', '9 мин'],
            ['min' => 60 * 10, 'max' => 60 * 20, '10 минут назад', '10 мин'],
            ['min' => 60 * 20, 'max' => 60 * 30, '20 минут назад', '20 мин'],
            ['min' => 60 * 30, 'max' => 60 * 60, 'пол часа назад', '30 мин'],
            ['min' => 60 * 60, 'max' => 60 * 60 * 2, '1 час назад', '1 ч'],
            ['min' => 60 * 60 * 2, 'max' => 60 * 60 * 3, '2 часа назад', '2 ч'],
            ['min' => 60 * 60 * 3, 'max' => 60 * 60 * 4, '3 часа назад', '3 ч'],
            ['min' => 60 * 60 * 4, 'max' => 60 * 60 * 5, '4 часа назад', '4 ч'],
            ['min' => 60 * 60 * 5, 'max' => 60 * 60 * 6, '5 часов назад', '5 ч'],
            ['min' => 60 * 60 * 6, 'max' => 60 * 60 * 7, '6 часа назад', '6 ч'],
            ['min' => 60 * 60 * 7, 'max' => 60 * 60 * 8, '7 часов назад', '7 ч'],
            ['min' => 60 * 60 * 8, 'max' => 60 * 60 * 9, '8 часов назад', '8 ч'],
            ['min' => 60 * 60 * 9, 'max' => 60 * 60 * 10, '9 часов назад', '9 ч'],
            ['min' => 60 * 60 * 10, 'max' => 60 * 60 * 11, '10 часов назад', '10 ч'],
            ['min' => 60 * 60 * 11, 'max' => 60 * 60 * 12, '11 часов назад', '11 ч'],
            ['min' => 60 * 60 * 12, 'max' => 60 * 60 * 13, '12 часов назад', '12 ч'],
            ['min' => 60 * 60 * 13, 'max' => 60 * 60 * 14, '13 часов назад', '13 ч'],
            ['min' => 60 * 60 * 14, 'max' => 60 * 60 * 15, '14 часов назад', '14 ч'],
            ['min' => 60 * 60 * 15, 'max' => 60 * 60 * 16, '15 часов назад', '15 ч'],
            ['min' => 60 * 60 * 16, 'max' => 60 * 60 * 17, '16 часов назад', '16 ч'],
            ['min' => 60 * 60 * 17, 'max' => 60 * 60 * 18, '17 часов назад', '17 ч'],
            ['min' => 60 * 60 * 18, 'max' => 60 * 60 * 19, '18 часов назад', '18 ч'],
            ['min' => 60 * 60 * 19, 'max' => 60 * 60 * 20, '19 часов назад', '19 ч'],
            ['min' => 60 * 60 * 20, 'max' => 60 * 60 * 21, '20 часов назад', '20 ч'],
            ['min' => 60 * 60 * 21, 'max' => 60 * 60 * 22, '21 час назад', '21 ч'],
            ['min' => 60 * 60 * 22, 'max' => 60 * 60 * 23, '22 часа назад', '22 ч'],
            ['min' => 60 * 60 * 23, 'max' => 60 * 60 * 24, '23 часа назад', '23 ч'],
            ['min' => 60 * 60 * 24, 'max' => 60 * 60 * 24 * 2, '1 день назад', '1 д'],
            ['min' => 60 * 60 * 24 * 2, 'max' => 60 * 60 * 24 * 3, '2 дня назад', '2 д'],
            ['min' => 60 * 60 * 24 * 3, 'max' => 60 * 60 * 24 * 4, '3 дня назад', '3 д'],
            ['min' => 60 * 60 * 24 * 4, 'max' => 60 * 60 * 24 * 5, '4 дня назад', '4 д'],
            ['min' => 60 * 60 * 24 * 5, 'max' => 60 * 60 * 24 * 6, '5 дней назад', '5 д'],
            ['min' => 60 * 60 * 24 * 6, 'max' => 60 * 60 * 24 * 7, '6 дней назад', '6 д'],
            ['min' => 60 * 60 * 24 * 7, 'max' => 60 * 60 * 24 * 7 * 2, '1 неделю назад', '1 нед'],
            ['min' => 60 * 60 * 24 * 7 * 2, 'max' => 60 * 60 * 24 * 7 * 3, '2 недели назад', '2 нед'],
            ['min' => 60 * 60 * 24 * 7 * 3, 'max' => 60 * 60 * 24 * 7 * 4, '3 недели назад', '3 нед'],
            ['min' => 60 * 60 * 24 * 7 * 4, 'max' => 60 * 60 * 24 * 7 * 4 * 2, '1 месяц назад', '1 мес'],
            ['min' => 60 * 60 * 24 * 7 * 4 * 2, 'max' => 60 * 60 * 24 * 30 * 3, '2 месяца назад', '2 мес'],
            ['min' => 60 * 60 * 24 * 30 * 3, 'max' => 60 * 60 * 24 * 30 * 4, '3 месяца назад', '3 мес'],
            ['min' => 60 * 60 * 24 * 30 * 4, 'max' => 60 * 60 * 24 * 30 * 5, '4 месяца назад', '4 мес'],
            ['min' => 60 * 60 * 24 * 30 * 5, 'max' => 60 * 60 * 24 * 30 * 6, '5 месяцев назад', '5 мес'],
            ['min' => 60 * 60 * 24 * 30 * 6, 'max' => 60 * 60 * 24 * 30 * 7, '6 месяца назад', '6 мес'],
            ['min' => 60 * 60 * 24 * 30 * 7, 'max' => 60 * 60 * 24 * 30 * 8, '7 месяцев назад', '7 мес'],
            ['min' => 60 * 60 * 24 * 30 * 8, 'max' => 60 * 60 * 24 * 30 * 9, '8 месяцев назад', '8 мес'],
            ['min' => 60 * 60 * 24 * 30 * 9, 'max' => 60 * 60 * 24 * 30 * 10, '9 месяцев назад', '9 мес'],
            ['min' => 60 * 60 * 24 * 30 * 10, 'max' => 60 * 60 * 24 * 30 * 11, '10 месяцев назад', '10 мес'],
            ['min' => 60 * 60 * 24 * 30 * 11, 'max' => 60 * 60 * 24 * 30 * 12, '11 месяцев назад', '11 мес'],
            ['min' => 60 * 60 * 24 * 30 * 12, 'max' => 60 * 60 * 24 * 30 * 12 * 2, '1 год назад', '1 год'],
            ['min' => 60 * 60 * 24 * 30 * 12 * 2, 'max' => 60 * 60 * 24 * 30 * 12 * 3, '2 года назад', '2 года'],
            ['min' => 60 * 60 * 24 * 30 * 12 * 3, 'max' => 60 * 60 * 24 * 30 * 12 * 4, '3 года назад', '3 года'],
            ['min' => 60 * 60 * 24 * 30 * 12 * 4, 'max' => 60 * 60 * 24 * 30 * 12 * 5, '4 года назад', '4 года'],
        ];
    }
    ...
    public static function backInt($date, $options)
    {
        $start = $date;
        $now = time();
        if ($start > $now) return $options['messageGregerThenNow'];
        $diff = $now - $start;
